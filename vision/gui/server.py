...
def module_not_running(e):
    return 'That module is not currently running', 412
...
def initialize_module(module_name):
    ...
    module_frameworks[module_name].register_image_observer(image_observer)

    option_observer = get_option_observer(module_name)
    module_frameworks[module_name].register_option_observer(option_observer)
