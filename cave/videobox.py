        ...
        with self.grab_lock:
            ...
            if self.last_frame is None or frame_number != self.last_frame + 1:
                if frame_number < 0: #DEBUG DEBUG DEBUG
                    ...
                    self.cap.set(cv.CV_CAP_PROP_POS_FRAMES, frame_number)
...
class VideoBox(Gtk.DrawingArea):
    ...
    def load_video(self, video):
        ...
        self.vmt.camlink = CameraLink(video.linked_camera, height=self.height, width=self.width, nChannels=self.nchannels)
